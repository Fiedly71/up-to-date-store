                      ...
                      <div className="flex-grow flex flex-col justify-between">
                        ...
                        <div className="flex flex-wrap items-center gap-3 mt-4">
                          <button
                            ...
                            className="flex items-center gap-2 text-red-600 hover:text-white hover:bg-red-600 px-3 sm:px-4 py-2 rounded-xl font-semibold transition-all duration-300 border-2 border-red-600 text-sm sm:text-base shrink-0"
                          >
                            <Trash2 size={18} />
